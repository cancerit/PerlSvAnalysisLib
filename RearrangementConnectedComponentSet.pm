...
package RearrangementConnectedComponentSet;
...
sub new {
    ...
    if (exists $params{components}) {
        for (@{$params{components}}) {
            if (!defined(Scalar::Util::blessed $_) or Scalar::Util::blessed($_) ne 'RearrangementConnectedComponent') {
                die "Array elements of dereferenced argument 'components' must be of class 'RearrangementConnectedComponent' in $class\->RearrangementConnectedComponentSet";
            }
